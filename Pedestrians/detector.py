...
import sys 
sys.path.append('C:/Users/Darwin/Documents/GitHub/PdIV/Pedestrians/Tools')
...
def testFolder(inputfolder, outputfolder, decisionThreshold = cfg.decision_threshold, applyNMS=False):
