...
#sys.path.insert(0, '/Users/Gustavo/AnacondaProjects/pythonCode/7_Librerias/signals/')
#sys.path.insert(0, '/Users/Gustavo/AnacondaProjects/pythonCode/7_Librerias/Enhancement/')
